...
router.get('/rouge/elukaigud_metsaelu_alguseni',function(req,res){
	res.render('rouge/elukaigud_metsaelu_alguseni', {layout: 'rouge-layout.hbs'});
});
router.get('/rouge/sundmused_uurimistoimikutes',function(req,res){
	res.render('rouge/sundmused_uurimistoimikutes', {layout: 'rouge-layout.hbs'});
});
...
router.get('/rouge/aksel_sprenki_paevik_umberkirjutis',function(req,res){
	res.render('rouge/aksel_sprenki_paevik_umberkirjutis', {layout: 'rouge-layout.hbs'});
});
